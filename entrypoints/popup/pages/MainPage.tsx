...
function MainPage() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="pb-2 mb-4 border-b border-black dark:border-gray-700 flex justify-between items-center">
          ...
          <div className="flex gap-2 items-center">
            ...
            <select
              ...
              className="px-3 py-1 rounded text-sm font-medium border border-gray-300 dark:border-gray-600 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600"
            >
        ...
        <div className="flex items-start justify-center gap-4">
          ...
          <div className="ml-2 flex justify-center w-[330px]">
            <div
              className="w-[400px] h-[425px] rounded-xl shadow p-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700"
            >
              <List data={dataEntry} />
            </div>
          </div>
      ...
      {/* Footer */}
      <div className="fixed bottom-0 left-0 z-50 w-full h-12 bg-gray-200 dark:bg-gray-800 border-t border-gray-300 dark:border-gray-700">
